    ...
    return careers
      .filter(career => {
        const matchesSearch = 
          ...
          career.necessarySkills.some(s => s.toLowerCase().includes(searchTerm.toLowerCase())) ||
    ...
    <div className="space-y-6 sm:space-y-8 pb-16">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/80 backdrop-blur-md border border-purple-200/80 text-xs font-bold text-purple-800 shadow-xs">
              ...
              <span>Catálogo Profesional Completo</span>
            </div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 max-w-2xl">
              Descubre los planes de estudio, salarios estimados, campos laborales y habilidades necesarias para cada profesión.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
          ...
          <div className="sm:col-span-2 relative">
            ...
            <input
              ...
              placeholder="Buscar por nombre, área o habilidad (ej. Software, Medicina, Diseño)..."
      ...
      {filteredCareers.length === 0 ? (
        <div className="p-12 text-center bg-white/70 backdrop-blur-2xl rounded-3xl sm:rounded-[32px] border border-white/80 shadow-xs space-y-3">
          ...
          <p className="text-xs text-slate-500">Prueba con otras palabras clave o restablece los filtros.</p>
          <button
            onClick={() => {
              setSearchTerm('');
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {matchObj && (
                      <span className="text-[11px] font-extrabold px-2.5 py-0.5 rounded-full bg-emerald-100/90 backdrop-blur-sm border border-emerald-200/60 text-emerald-800 flex items-center gap-1 shadow-xs">
                ...
                <div className="space-y-3 pt-3 border-t border-slate-200/50">
                  <div className="flex items-center justify-between text-xs text-slate-500">
                    ...
                    <span className="font-bold text-emerald-700">
                      {career.averageSalaryRange.split('-')[0]}
                    </span>
                  </div>
