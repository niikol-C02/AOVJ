...
# -*- coding: utf-8 -*-
"""
VOCACCIÓN - COLOMBIAN UNIVERSITIES AND SCHOLARSHIPS BUILDER
Writes: src/models/colombianUniversitiesData.ts
161 Universities and IES + 38 Scholarships
"""

import json

# 1. Base 16 universities
base_16 = [
  {
    "id": "uni-unal",
...
print("Saved base 16. Now running generator for remaining...")
