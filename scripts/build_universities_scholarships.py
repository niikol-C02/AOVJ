...
# -*- coding: utf-8 -*-
"""
Full Colombian Universities and Scholarships Data Builder
Produces: src/models/colombianUniversitiesData.ts
161 Universities across all 32 departments + 38 Scholarships
"""
...
# Helper
def add_uni(uid, name, shortName, utype, city, department, logoText, badgeBg, desc, topCareers, reqs, tuition, highlights, webUrl, rating=4.6, accred="Acreditación Institucional de Alta Calidad (MEN)"):
    unis.append({
        "id": uid,
        "name": name,
        "shortName": shortName,
...
print("16 base universities preserved. Now building remaining institutions...")
