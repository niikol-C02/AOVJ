...
# -*- coding: utf-8 -*-
"""
VOCACCIÓN FULL DATABASE GENERATOR
Generates:
...
3. src/models/careersData.ts (seamlessly combined catalog of 1,081+ careers)
"""
...
# ==============================================================================
# 1. 161 COLOMBIAN UNIVERSITIES AND IES (Covering all 32 departments + Bogotá)
# ==============================================================================

# Helper for creating university objects
def make_uni(id, name, shortName, utype, city, department, logoText, badgeBg, desc, topCareers, reqs, tuition, highlights, webUrl, rating=4.6, accred=None):
    return {
        "id": id,
        "name": name,
        "shortName": shortName,
...
print(f"Base 16 loaded. Now appending the remaining 145 Colombian institutions...")
