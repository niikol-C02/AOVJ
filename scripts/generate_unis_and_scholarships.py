...
- Exactly 161 universities & higher education institutions in Colombia across all 32 departments
- Exactly 38 scholarships (national, departmental, institutional, ethnic, foundation, international)
"""

import os
import json

print("Building Colombian Universities and Scholarships dataset...")

# Core base 16 universities
base_unis = [
  {
    "id": "uni-unal",
...
print(f"Base universities loaded: {len(base_unis)}")
