...
# -*- coding: utf-8 -*-
"""
VOCACCIÓN FULL HIGHER EDUCATION DATABASE GENERATOR
Generates:
1. src/models/colombianUniversitiesData.ts (161 universities across all 32 departments + 38 scholarships)
2. src/models/careersCatalog.ts (1,050+ official Colombian academic programs from SNIES)
3. src/models/careersData.ts (Seamlessly re-exports 1,081+ total careers)
"""

import json
import os

print("Starting generation of VocAcción Colombian Higher Education Database...")

# ==============================================================================
# 1. GENERATE UNIVERSITIES (161 institutions)
# ==============================================================================
unis = []
...
print(f"Loaded 16 base universities. Total now: {len(unis)}")
