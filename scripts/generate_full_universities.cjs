...
console.log('--- GENERATING COLOMBIAN UNIVERSITIES AND SCHOLARSHIPS DATA ---');

// 1. Existing 16 universities (preserved identically)
const existingUnis = [
  {
    id: 'uni-unal',
...
console.log('Existing universities count:', existingUnis.length);
