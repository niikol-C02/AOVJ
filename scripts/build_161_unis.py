...
# -*- coding: utf-8 -*-
"""
VOCACCIÓN - Full Colombian Higher Education Institutions (161) & Scholarships (38) Generator
Writes: src/models/colombianUniversitiesData.ts
"""

import json
import os

print("Starting generation of 161 universities and 38 scholarships...")
...
def get_base_16():
  ...
  },
  {
    ...
    "campusHighlights": [
      ...
      "Consultorio Juriddico galardonado por su servicio gratuito a comunidades desfavorecidas"
    ],
