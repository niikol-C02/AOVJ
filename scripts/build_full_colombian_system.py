...
Builds:
- src/models/colombianUniversitiesData.ts (161 Higher Education Institutions, 38 Scholarships)
- src/models/careersCatalog.ts (1,050+ Colombian academic programs from official SNIES standards)
- src/models/careersData.ts (Merged catalog of 1,081+ careers)
"""
...
# Helper to create university
def make_uni(uid, name, shortName, utype, city, dept, logo, badge, desc, careers, reqs, tuition, highlights, web, rating=4.6, accred=None):
    return {
        "id": uid,
        "name": name,
        "shortName": shortName,
        ...
        "websiteUrl": web,
        "rating": rating,
        "accreditation": accred or ("Acreditación Institucional de Alta Calidad (MEN)" if utype == "Pública" or rating >= 4.7 else "Registro Calificado MinEducación")
    }

# ==============================================================================
# 1. 161 UNIVERSIDADES E INSTITUCIONES DE EDUCACIÓN SUPERIOR EN COLOMBIA
# ==============================================================================
universities = []
...
print(f"Loaded {len(universities)} base universities.")
