...
# -*- coding: utf-8 -*-
"""
Builds src/models/colombianUniversitiesData.ts with:
- 161 Higher Education Institutions (Universidades e IES de Colombia)
- 38 Verified Colombian Scholarships & Funding Opportunities
"""

import json

# ==============================================================================
# 1. 161 UNIVERSITIES DATA
# ==============================================================================
raw_universities = [
  # 1. ORIGINAL 16 UNIVERSITIES
  {
    "id": "uni-unal",
...
print(f"Loaded {len(raw_universities)} base universities.")
