...
# -*- coding: utf-8 -*-
"""
VOCACCIÓN FULL HIGHER EDUCATION DATABASE BUILDER
Builds:
1. src/models/colombianUniversitiesData.ts (161 Universities and IES across Colombia + 38 Scholarships)
2. src/models/careersCatalog.ts (1,050+ Colombian academic programs with SNIES metadata)
...
print("Starting generation pipeline for VocAcción...")
...
# ==============================================================================
# 1. UNIVERSITIES (161 institutions)
# ==============================================================================
base_16 = [
  {
    "id": "uni-unal",
...
print("Base 16 loaded successfully.")
